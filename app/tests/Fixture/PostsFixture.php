...
class PostsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'post_image' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2021-07-30 14:59:43',
                'updated' => '2021-07-30 14:59:43',
            ],
        ];
        parent::init();
    }
