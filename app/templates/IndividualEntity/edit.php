...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $individualEntity->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $individualEntity->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="individualEntity form content">
            ...
            <fieldset>
                <legend><?= __('Edit Individual Entity') ?></legend>
                <?php
